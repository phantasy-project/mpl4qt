...
class MatplotlibBarWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    """MatplotlibBarWidgetPlugin(QPyDesignerCustomWidgetPlugin)

    Provides a Python custom plugin for Qt Designer by implementing the
    QDesignerCustomWidgetPlugin via a PyQt-specific custom plugin class.
    """
    def __init__(self, parent=None):
        super(MatplotlibBarWidgetPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        return MatplotlibBarWidget(parent)

    def name(self):
        return "MatplotlibBarWidget"
    ...
    def domXml(self):
        return '<widget class="MatplotlibBarWidget" name="matplotlibbarWidget" />\n'
