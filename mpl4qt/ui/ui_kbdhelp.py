...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.label_20, 10, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_24.setText(
            _translate(
                "Dialog",
                "<html><head/><body><p>Auto X scale (only curve)</p></body></html>"
            ))
        self.label_25.setText(_translate("Dialog", "a,y"))
        self.label_26.setText(
            _translate(
                "Dialog",
                "<html><head/><body><p>Auto Y scale (only curve)</p></body></html>"
            ))
        self.label_21.setText(_translate("Dialog", "c"))
        self.label_22.setText(
            _translate("Dialog", "Change colormap (only image)"))
        ...
        self.label_20.setText(
            _translate("Dialog", "Change y-axis scale (only curve)"))
