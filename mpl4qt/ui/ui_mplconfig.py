...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.legend_on_checkBox = QtWidgets.QCheckBox(self.figure_tab)
        self.legend_on_checkBox.setObjectName("legend_on_checkBox")
        self.horizontalLayout_4.addWidget(self.legend_on_checkBox)
        ...
        self.legend_loc_cbb.addItem("")
        self.legend_loc_cbb.addItem("")
        self.horizontalLayout_4.addWidget(self.legend_loc_cbb)
        ...
        self.legend_on_checkBox.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.legend_on_checkBox.setText(_translate("Dialog", "On"))
